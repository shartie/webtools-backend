...
class SummaryBase(BaseModel):
    ...
    short_description: str = Field(..., max_length=500, description="Short description of the summary")
    content: str = Field(..., description="Markdown formatted content of the summary")
    status: str = Field("draft", max_length=50, description="Status of the summary (e.g., draft, published)")
    is_deleted: bool = Field(False, description="Flag to indicate if the summary is deleted")
    user_id: Optional[str] = Field(None, max_length=255, description="ID of the user who owns the summary")
