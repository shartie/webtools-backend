...
def upgrade() -> None:
    ...
    op.create_table(
        'User',
        # sa.Column('id', sa.Integer, primary_key=True),
        sa.Column('id', sa.String(255), primary_key=True, default=lambda: str(uuid.uuid4())),
        #sa.Column('id', UUID(as_uuid=True), nullable=True, unique=True, default=uuid.uuid4, primary_key=True),
        sa.Column('guid', UUID(as_uuid=True), nullable=True, unique=True, default=uuid.uuid4),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer, primary_key=True),
        sa.Column('guid', UUID(as_uuid=True), nullable=False, unique=True, default=uuid.uuid4),
        sa.Column('user_id', sa.String, sa.ForeignKey(f'{settings.database.schema}.User.id', ondelete='SET NULL'), nullable=True),
        sa.Column('title', sa.String(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('userId', sa.String, sa.ForeignKey(f'{settings.database.schema}.User.id', ondelete='CASCADE'), nullable=False),
        ...
        sa.UniqueConstraint('provider', 'providerAccountId', name='uq_provider_providerAccountId'),
        schema=settings.database.schema
    )
